...
- **Escenario 1 (“Crear Reel”)**: ![image.png](../imagenes/9d04a21e85b1454ca5f5218321745c5fb7153ace21ae48d0bc30bc44044b65ac-md.png) 1. Lee el siguiente tema pendiente en Google Sheets.
...
- **Escenario 2 (“Subir Reel”)**  ![image.png](../imagenes/85e51676bec44310b6ef593f68f4db23ead1d0901fdc48fea9a7e2936a271c6f-md.png) 1. Se dispara cuando termina la generación del video (webhook) en Freepik (Kling).
...
1. **Disparador: Google Sheets → SearchRows** ![image.png](../imagenes/a030326fce284883b1c42b2123a0bf23bfed57b012a94c29adcd8c939f067e05.png) - Filtra la hoja “Reels” buscando la primera fila con estado “0” (pendiente). ![image.png](../imagenes/c3a1e3ef9b3d40c483cbb6c4a040677b730f936a464342f1a541c8b5d22f5705.png)
2. **ChatGPT:  Create a Chat Completion (Crear prompt de imagen)** ![image.png](../imagenes/2ce66b434a0849a5a901a49de48a6cbea16ada4ebfb647298995a10b53a6d95b.png) - Módulo `openai-gpt:CreateCompletion` (o4-mini).
...
> 
> }
3. **Freepik: (Make an API Call) Generar imagen** ![image.png](../imagenes/338d1f0844d8412980a66e3b3701ecef0d9ea9bf782a4479a05e30637598a9ab.png) - Llamada a `/v1/ai/text-to-image/imagen3` con el prompt generado, ratio 9:16.

![image.png](../imagenes/0caffc3baa0244119ec320ee2ed39e14e250cdf1c70c4b6aa22a2c7b32246e07.png)
...
1. **Tools: Sleep (Delay de 15 s)** ![image.png](../imagenes/b0ce15202f2d47f8b8179c80156373d5ac2263bbc88b48b882a0235d8b26acfa-md.png)

- Pausa para que Freepik complete la tarea.

1. **Freepik: Obtener URL de imagen** ![image.png](../imagenes/29a0ec000ff94f0c841f4d6625f4b9916f57b6b96f2143449f6bf9b970a51835-md.png)

- `GET /v1/ai/text-to-image/imagen3/{task_id}` ![image.png](../imagenes/047e558404bd40dc899eeb12ac8d900c22f2db3fde914c08b218685a38c50780.png)

1. **HTTP: Get a File (Descargar Imagen)** ![image.png](../imagenes/b4c7d678c9214d0db9e57e8b350da558c4f14990765c40e4ae43e04629db0f84-md.png)

- Módulo `http:ActionGetFile` para bajar la imagen.

![image.png](../imagenes/5640be37c9614568a508f8c9726bb37233b8eaba76a54c20a11d421a1f474277.png)

1. **ChatGPT: Crear prompt de video** ![image.png](../imagenes/a932624607954b41b3abb36be95090cd6b7c24ed056d4a3a955441dcdcd92611-md.png)
...
![image.png](../imagenes/adf8f11515ac4e5b9dbbecede3d46740ae2768dd384b4f3794815384b8f78cb4.png)

![image.png](../imagenes/bd26fa7804004374bd2750f585d39cfd95174e82c0454a3fad9ac9e21935b41c.png)

![image.png](../imagenes/a48577a8a6a84fdd98473c406227243acc9988d1dc4947c789c11f238ec0b97c.png)

1. **Create JSON: (Data Structure) Estructura para video** ![image.png](../imagenes/429f2b76c22e477cac9332e0043b5cd5b8ffb128287243b6bb91fa9b513b61e2-md.png)

Luego le daremos a "ADD"

![image.png](../imagenes/0aab26dca03b465bb00d7a4e79c364ab95f9be4db82c40ca958a452f7dd5a2ee.png)

Y luego le daremos a "Generate"

![image.png](../imagenes/b94bd2d3531e45b8a0e119b000ef21e538e8234d846e4932a2bde6c11417867c.png)

Y en sample data

![image.png](../imagenes/792477024f1d4b18a74e756e5c9c7150e2ed1cccfcab4c82a0e6452f353eab33.png)
...
![image.png](../imagenes/29f994a344714302a5882d64bd7a4c7808fd05d60f2a4e5dbb0ed8fc3a32d2a0.png)
...
1. **Freepik: Make an API Call (Generar video con Kling)** ![image.png](../imagenes/a69d1601d87a4986bb96bd918783d47009f400a304584720804abde46592fafe-md.png)

- POST a `/v1/ai/image-to-video/kling-pro` usando el JSON anterior. ![image.png](../imagenes/922c015081b2466e848b59f125537f3219b9e01d2d9c4f7780d8bd71e44f6709.png) Y seleccionaremos la variable que creamos anteriormente.

1. **ChatGPT: Create a Completion (Música): **Crea prompt para MusicFy basado en el script y la imagen. ![image.png](../imagenes/065ff6a2fe9e49c6831ca0c6bba168a4756a3caf4dbb451daf40c47517a20055-md.png) > PROMPT MUSICA:   
>   
...
>   
> Video Script : {{50.result.prompt}} ![image.png](../imagenes/119fb139987e43ffadf4df802aa62f32114fa6e7f9b547ea9f1e5b4c41337077.png)

![image.png](../imagenes/75fac601cef642abb8f3ff274487ab8910cf608410534886b75d44139657b9fb.png)

1. **ChatGPT: Create a Completion (Caption)** ![image.png](../imagenes/6e8110e11f7449e79673b748c33f85677a260fc9ce9b416a9b6ce4c028a3caf9-md.png) >  You have to create a short, attention-grabbing Instagram caption (under 150 characters) that matches the vibe of the video — surreal, funny, satisfying, or weirdly cool — and encourages viewer engagement.
> 
...
>   
> {{[46.body.data](http://46.body.data).generated[]}} ![image.png](../imagenes/ad434c088e7f4c49a133cef64c2eeaa707c0962f8a8146bd8c9a6cd1ae90da8f.png)   
`gpt-4.1-mini` genera un caption corto (<150 car.) para Instagram.
2. **DataStore: AddRecord**

![image.png](../imagenes/6d438fb06ae040f0b3ddd82c33335ca0faafbc428410407ea069b087c3b19fee-md.png)

- Guarda en el DataStore “Ad Reels” el ID de video, prompt de música, caption y número de fila.

![image.png](../imagenes/3542c83111944a0c8b1b0d8428d77841a8dbb88921c04ac5882a77ef297a0c0b.png)

Es probable que tengas que tengas que crear una Data Store y Data Structure antes aqui  


![image.png](../imagenes/5b9df2c69bed43ef931f366d460641aae3a0ece5e1034e498f6154935577f5c9.png)

Le das a "Add Item"

![image.png](../imagenes/b1aa6fcde0c54ed8a1aee52ef0502e092816ecf02a1d45c3b36e6f4845da998d.png)

Y vas agregando los items manualmente, ID Video, Prompt Musica, Caption, Numero Fila.

![image.png](../imagenes/35ddc21d773243b3b2ca2786ff3b23cc31c6e6dfa44c4af19320fa647dd2ad38.png)
...
![image.png](../imagenes/28cc229ac35949d7bc03b8bbee497d880755925221b7444eb59aafe2a5f63245-md.png)

1. **Disparador: Custom Webhook** ![image.png](../imagenes/64e35c9cd4a7422f8b6ed62b7170f383c788f639a682413d8639fbdd9dadb6a4.png) - Crearás un nuevo webhook (es el webhook que tenemos que reemplazar en el custom JSON de la automatizacion 1). **Se activa cuando Freepik/Kling notifica que el video está listo.** 1.5 **Filtro** ante "Completed": Se activará el filtro cuand oel estado de la generación del video esté **"COMPLETED"** ![image.png](../imagenes/82b082004f8c43799fc18e5ad42d2d5db6d32697f65349eaae862cac4d279176.png)
2. **DataStore: SearchRecord** ![image.png](../imagenes/8846cc8490ae471e9ee7563d2d23c2f8667052911db74a53b7ac360258b046cc-md.png) - Busca en el datastore específico la información que guardamos previamente en el registro, filtraremos cuyo ID de video (task_id) coincida con el recibido en el webhook.

![image.png](../imagenes/d3c7a0dfb85a4b878f2e251fb155edf9fb12493d2a7340748604c42c3cc7b96d.png)

1. **HTTP: Make a Request (MusicFy: Generar música)** ![image.png](../imagenes/57f67e1878504a008eee42d77d1616ff2750091cc20d4ae9ad16e9743b259e25-md.png)

- `http:ActionSendData` POST a `https://api.musicfy.lol/v1/generate-music` con el prompt guardado.

![image.png](../imagenes/2007fe0b14f84f359dc276464b58c6c4b3872676379444f7b518964354509cfe.png)

Nota: Tienes que crearte la [API de MusicFY ](https://musicfy.lol/api)e incluirla y pegarla bajo "Authorization"

![image.png](../imagenes/3e7e24945ad04bdda16a4d5852a9ad46902f252a37c7472e97dd9da8bf7d04ed-md.png)
...
1. **Tools: Sleep (Delay de 15 s)** ![image.png](../imagenes/75405a1a643142ef85e46e45114a97e8c8310b778a144979b36bc296b9299464-md.png)

- Asegura que MusicFy termine la generación.

1. **HTTP: Maque a Request (Segmind: Combinar video y música)** ![image.png](../imagenes/3b7a415713424d26bd975ec974523bd1faaf80837826478a8a95392279b0b4c6-md.png)

- `http:ActionSendData` a `https://api.segmind.com/v1/video-audio-merge` con URLs de video y audio.

![image.png](../imagenes/35586d7a825b42b8a2b6246acf6cf14ec90c988a5b60402ea515b1e05880b1ed.png)
...
![image.png](../imagenes/10e3cdf25e224841b197f63abc6188463322db7e8b5e44fcac60511525a0c23e-md.png)

apretando "get your api-key".

1. **Dropbox: Upload a File ** ![image.png](../imagenes/74fbec9eeb034a6eab8c6d77e48f1f14db22b7067e5b42ddadb4417e6843ab6b-md.png)
...
![image.png](../imagenes/77fcc8b0eb5a47b18c891095e21112b1c9317d509f18409a940f64219dbfaa02.png)

1. **Error Handler** (Break)

![image.png](../imagenes/dfbea802528b4349b6fe5d12e2709313a0ff8a35c2754d30958deec12e095bd2.png)
...
![image.png](../imagenes/8a16d13c18fd426cbadd56fa6f0cfd1c121b9a257fe84f9f896475e29d73d7c6.png)

1. **Dropbox: Create/Update Share Link** ![image.png](../imagenes/6b9e417c55004f53a2164eab79d21fc90496e267b6b3412e8a49a04a5b9344d3-md.png)

- Obtiene un enlace público de descarga.

![image.png](../imagenes/c983ba509fbb4ad0bf78302c796f0d9c50ef4a6857654eb1bdbc1fc56be8bdad.png)

1. **Instagram Business: Crear Reel** ![image.png](../imagenes/cc2c75a31c3c4f1b9a54394d0d7870e16569e2c999d04635914a8869b1cf876e-md.png)

- Módulo “Create a reel post” mapea el enlace de Dropbox y el caption.

![image.png](../imagenes/2b3c964548f747199d243e3ea8b3a2824a369df55c0e41548852ee706e986c64.png)

1. **Google Sheets: Update a Row** ![image.png](../imagenes/7756ab79635f41448a37d1895ccf4ae8bdb172c07cdd457ba85af3bf18fb64cc-md.png)

- Marca la fila correspondiente como “1” (Done) para no volver a procesarla.
- Especifica el URL

![image.png](../imagenes/671d6cd68dfc47da8080e3ec701b222d3c769fb59719460590f0e363cfaba89d.png)
