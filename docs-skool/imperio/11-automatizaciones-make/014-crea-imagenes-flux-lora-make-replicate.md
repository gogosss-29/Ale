...
![image.png](../imagenes/6bbe2c504602474190ec085cad1e784c7d726172f99d42f4b9fc35c46094d4a9.png)

Lo copiaremos

![image.png](../imagenes/2495ba71b380418c863d2d738c7b83eeac467ca448c645aab5df5c8da52dc0af.png)
...
![image.png](../imagenes/1df50f5c8d8f4f09868cdb1fdab094dac7d96fc8f0524c048f8c4f6e3da0ea13.png)
...
![image.png](../imagenes/eb783fd7239a4687bcde1222b0bfc53af28eed58c8004da79daf3a45f73dc0f1-md.png)

Luego, correremos el escenario en Make

![image.png](../imagenes/cd3fc62a349147b29e4a0c4813ae381464dac7ccb51f4eb2b53883dc53a4ef17.png)

y mandaremos la información en la interfaz de bolt

![image.png](../imagenes/b27307f4187f4d02aeb749a982724c71589bd13505ac4aa0baefc0a353260d87-md.png)

para verificar que estamos recibiendo la informacion en el escenario

![image.png](../imagenes/95fa9416750540c58762d90ec6269e126ee3caa2a7f742e2b001b51d4ee31932.png)
...
![image.png](../imagenes/bd379ccf8edc43c0b58be80d95489898d262dfc49d114eea9ca9e057bed9d80b-md.png)
...
![image.png](../imagenes/87c2ae963c5a4436a6556acd193a2caa3b9bf82257e8485a80e3786280fbfb62.png)

y le pegaremos el siguiente prompt (está escrito abajo):  
  
TIP: Pegarlo con CTRL + SHIFT + V para mantener el formato

![image.png](../imagenes/5eeeea7644c646dab70337a35b4e8c530979af702cf1447fbba010357e48fcae.png)
...
![image.png](../imagenes/df5b91fd8cf84319873cce4cb670312a15c3f11b21e54b259e7885feabf95961.png)
...
![image.png](../imagenes/7cce0f41585847cba8bdd2e6f441581054d6a421f448426ea7969a997acc425c.png)

Luego agregaremos el modulo de Make a Request en HTTP

![image.png](../imagenes/92791f9dff56425b88cc2fcd5a42d28405c39a7f4aca413a9f55ceef8324e244.png)
...
![image.png](../imagenes/f296d7b2b5ae4a019fddd1eaf7868cd5d067c3cbb441487aaa32bc3c3b3ee40e.png)

Crearemos un nuevo Token

![image.png](../imagenes/1dd1c1ba128742479db920a99a277aba9e1d482167884af6a9726adbe8248f53.png)
...
![image.png](../imagenes/dc167bc67ddc4c95879aabbb09d732f823ebba3cb3d34e2f8a199b0dc99597e1.png)
...
![image.png](../imagenes/6951c7b4cd164dd4880ac229ccd499dda09684d3693d4d9693e8425984fe554c-md.png)

Y nos iremos a API y HTTP:

![image.png](../imagenes/bf00f79e634c4fb2853f0548bb04e6b1edbf9599a4f844c7b950eada1c404172.png)

Aquí nos aparecerá el siguiente código, que es el mismo dependiendo de la versión que tengamos

![image.png](../imagenes/7cd0a689f87346d69a727bba136c1450c5ddc6566e2d423f82182fc4e06b8cb6-md.png)

Tendremos que copiar el siguiente URL

![image.png](../imagenes/0fb6e097a33c4e0783f75bbec8ced1569182eabdfefb4dc0be177d6941d873be.png)
...
![image.png](../imagenes/3cc27df0903745c5a52cff1009c5cb373f26bd30f3a94247915b822cc81c5558.png)

con el que pusimos en el prompt de OpenAI

![image.png](../imagenes/75cf7310677244d68b1abdc663ea3d18e8ebf9ff665b4c1fa794c2905d0fd6e2.png)
...
![image.png](../imagenes/51d19c11f29b420a9ca9a7b3c9fe80d385823df4ab994bf2bd89bc2c2bef9e37.png)

Luego en Body Type le pondremos "Raw" y luego "JSON"

![image.png](../imagenes/d8f52df31b50477aa2e52b1157e5b1d8f376b11afc1145c8b84ba9a24ad889c4.png)

Finalmente en el request content, pondremos el resultado de OpenAI

![image.png](../imagenes/fc52c296dfbe4e5d9e4d9111070919c006e6c8bb9dfb4c95acc3ea3164fe7cec.png)

y en "Parse Response", le pondremos "Yes"

![image.png](../imagenes/e15cb4c609f44d8c89b839261427981692d236cf73c64fbb9a4fb85636d40850.png)

Y por último, SUPER importante, tenemos que tener el request en "POST"

![image.png](../imagenes/5582c9f5bf3d490ca1465af08515b108570bffd181fc4efeb3f1aa5999a45364.png)

Dandonos algo así

![image.png](../imagenes/b71cc521a8ee48a9a651a0f193906b6ff9f4c2013c3845ea91c6994a6bcd338e.png)
...
![image.png](../imagenes/bce3b0f48dde4d94953b499bd6e7fdc645bd5ef9b6204fde9f439ea0462449fa.png)
...
![image.png](../imagenes/8328665dc6c44504bdafea0fb0b8cf5bcb7de33e9e1e43a3830ca42012a9d525-md.png)

Mandamos la señal en Replicate

![image.png](../imagenes/e6c5587c226141b59a2c4cae9baabc5c472c8f039d494bc4901f29e2045a5ea7.png)

Y deberia aparecernos el escenario así

![image.png](../imagenes/d425ded2e2934b9499a67643c445e7ef8acd8c4e00294959a69eb8b9fbca7e46.png)

y si entramos a Replicate debería habernos comenzado a generar la imagen

![image.png](../imagenes/f325a797c38e4ad2a4af29893cbe20b26bb607c2dd164986a4e7845e26645eb6.png)

Dándonos algo así...

![image.png](../imagenes/f4cce3a6983749d3ab00b8fbf3826f16e1a38825a7a441129b645e0153e248d0.png)

Pero la mayoria de las generaciones toman alrededor de 20 a 30 segundos como pueden ver

![image.png](../imagenes/0910bb12c3ca469b8be623f1c8bde38b657d79b0ad7649959569431aa5321c21.png)
...
![image.png](../imagenes/8e0b20cc6ba34a989f07910af3b879d1fc90d5fe38ab406aa4c6bdbefe00b61a.png)

 que pausará la automatizacion por 50 segundos

![image.png](../imagenes/0abb4b366941413d9be628d4ec8b6f544ad8a46fc5834264865bd9f62731668f.png)
...
![image.png](../imagenes/b21c764765d5451e9a3ae5b9c00b5b18eeca66d8635d482887b6d0c83c486fbc.png)
...
![image.png](../imagenes/2172c41f291a4cf7a01c5f5cc6d739aef09f3e15c5b54cdd9ace498725f99cac.png)
...
![image.png](../imagenes/54bd6884d03e43feb65077d23fd1f7659686723abe7f4ed281f14aa1fae0fd57.png)
...
![image.png](../imagenes/e555c3a55b4647c1840f7323a3f45073397856abb8b341588db2c85aef0b4abb.png)

Y leugo en el resultado tras correr toda la automatizacion, abrimos "OUTPUT, Data, output y vemos el "1", habrá un link

![image.png](../imagenes/8fef5b3537d64e9e85d8f96e746183113ed1f784ed3d4b748bf18b3444aa4f7e.png)

Y si lo abrimos...

![image.png](../imagenes/3ed5aef070fe41beacd139db3e634c157621f39b96064e36856b4c80732171eb.png)
...
![image.png](../imagenes/c47baab1f92447fc94a77a17faff3facad8166af6735481380e8ce9c7297659e.png)

y seleccionaré el spreadsheet ID

![image.png](../imagenes/64a03dee262745959dce216c832a26894a5c18af483a491a8300dd7a8fefd594.png)

Bajo Prompt le pondré el prompt inicial

![image.png](../imagenes/5c6f6accb0824f928449d4345a972702dedc2b7550b1400489dcc9c4640ecefd.png)
...
![image.png](../imagenes/765ba124dddc4e72956f3361def76f4cf09638d72bed4d06a2dd94bee724824d.png)

Ahora guardaré, y cada vez que corra la automatización, se agregará nuevamente a un a un Sheets

![image.png](../imagenes/55092700c9b54e8183b8aaa8088ffd5f42671f6b5234438badc17e5e0b03a365.png)

Asegúrate de dejar activa la automatización dando click aquí

![image.png](../imagenes/fef784b89cf748429497200ee2c17797c55012d609e94f309f4c5f205fb40608.png)
