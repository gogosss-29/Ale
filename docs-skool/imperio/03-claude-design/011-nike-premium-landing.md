...
> Ruta: Claude Design › Nike Premium Landing

**📎 Recursos:**
- [Nike Premium Landing](https://motionsites.ai/?prompt=nike-premium-landing)

---

![hero-nike-premium-landing-preview-_VyIBlIe.gif](https://assets.skool.com/f/4e1ca14852434c0abdefff35382cdf66/45f54616ea3d420cbce3f6f9bbc367bb25bd1737f86840639779e92c1f16d391.gif)
...
> ```css
> 
> @import url('[https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Manrope:wght@400;500;600;700&display=swap](https://fonts.googleapis.com/css2?family=Instrument+Serif:ital@0;1&family=Manrope:wght@400;500;600;700&display=swap)');
> 
> @import "tailwindcss";
> 
> @theme {
...
> 
> .[menu-btn.open](http://menu-btn.open) .menu-line:not(.short) { transform: translateY(4px) rotate(45deg); }
> 
> .[menu-btn.open](http://menu-btn.open) .menu-line.short { transform: translateY(-4px) rotate(-45deg); width: 20px; }
> 
...
> 
>         [tl.to](http://tl.to)(bubble, { scale: 1, duration: animationDuration, ease: animationEase });
> 
>         if (labels[i]) [tl.to](http://tl.to)(labels[i], { y: 0, autoAlpha: 1, duration: animationDuration, ease: 'power3.out' }, `-=${animationDuration * 0.9}`);
> 
>       });
> 
>     } else if (showOverlay) {
...
>       gsap.killTweensOf([...bubbles, ...labels]);
> 
>       [gsap.to](http://gsap.to)(labels, { y: 24, autoAlpha: 0, duration: 0.2, ease: '[power3.in](http://power3.in)' });
> 
>       [gsap.to](http://gsap.to)(bubbles, { scale: 0, duration: 0.2, ease: '[power3.in](http://power3.in)', onComplete: () => { gsap.set(overlay, { display: 'none' }); setShowOverlay(false); } });
> 
>     }
> 
...
>   useEffect(() => {
> 
>     if (videoRef.current) { isPlaying ? [videoRef.current.play](http://videoRef.current.play)() : videoRef.current.pause(); }
> 
>   }, [isPlaying]);
> 
>   useEffect(() => {
...
>       </div>
> 
>       <svg className="absolute inset-0 w-full h-full" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)">
> 
>         <defs>
> 
...
>         <SpotlightReveal 
> 
>           imageSrc="[https://github.com/dsMagnatov/Acreage-landing-assets/blob/main/0098888.jpg?raw=true](https://github.com/dsMagnatov/Acreage-landing-assets/blob/main/0098888.jpg?raw=true)"
> 
>           videoSrc="[https://pikaso.cdnpk.net/private/production/4021778466/80a7f7ef-643d-40bc-b533-1e86f159d653-0.mp4?token=exp=1777075200~hmac=91d86c3600a89e923130fce0912dcfb0de81f05f2cde5fc77c30f3e7ae094342](https://pikaso.cdnpk.net/private/production/4021778466/80a7f7ef-643d-40bc-b533-1e86f159d653-0.mp4?token=exp=1777075200~hmac=91d86c3600a89e923130fce0912dcfb0de81f05f2cde5fc77c30f3e7ae094342)"
> 
...
> 
>           <svg width="120" viewBox="135.5 361.38 420.32 149.8" fill="white" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)">
> 
...
>         <SpotlightReveal 
> 
>           imageSrc="[https://github.com/dsMagnatov/Acreage-landing-assets/blob/main/02604201313.png?raw=true](https://github.com/dsMagnatov/Acreage-landing-assets/blob/main/02604201313.png?raw=true)"
> 
>           videoSrc="[https://pikaso.cdnpk.net/private/production/4024859125/d070ae9c-55df-47aa-acbe-4ee66337855c-0.mp4?token=exp=1777075200~hmac=4202c1d0ec90137eb6dffa8e0db93ed7569a68b2016165d8b1b567f888869ff5](https://pikaso.cdnpk.net/private/production/4024859125/d070ae9c-55df-47aa-acbe-4ee66337855c-0.mp4?token=exp=1777075200~hmac=4202c1d0ec90137eb6dffa8e0db93ed7569a68b2016165d8b1b567f888869ff5)"
> 
...
> 
>               <svg style={{ width: '160px', height: '80px' }} viewBox="0 0 289 138" fill="none" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)">
> 
...
> 
>               <svg width="86" viewBox="135.5 361.38 420.32 149.8" fill="white" xmlns="[http://www.w3.org/2000/svg](http://www.w3.org/2000/svg)">
> 
>                 <path d="m181.86 511.11c-12.524-0.49755-22.77-3.9244-30.782-10.289-1.529-1.2159-5.1725-4.8616-6.3949-6.3992-3.2489-4.0853-5.4578-8.0611-6.931-12.472-4.5334-13.579-2.2002-31.397 6.6737-50.953 7.5979-16.742 19.322-33.347 39.776-56.344 3.013-3.384 11.986-13.281 12.043-13.281 0.0216 0-0.46749 0.84706-1.083 1.8786-5.3183 8.9082-9.8689 19.401-12.348 28.485-3.9823 14.576-3.502 27.085 1.4068 36.784 3.3862 6.6822 9.1913 12.47 15.719 15.67 11.428 5.5993 28.159 6.0625 48.592 1.3554 1.4068-0.32599 71.116-18.831 154.91-41.123 83.794-22.294 152.36-40.52 152.37-40.505 0.0237 0.0193-194.68 83.333-295.75 126.56-16.007 6.8431-20.287 8.5715-27.812 11.214-19.236 6.7551-36.467 9.9783-50.396 9.4251z"/>
> 
>               </svg>
