...
> Ruta: Claude Design › Sentinel AI

**📎 Recursos:**
- [Sentinel AI](https://motionsites.ai/?prompt=sentinel-ai-hero)
- [Sentinel AI Video](https://stream.mux.com/ef2TghmWccnsK54qnxtFWjv36zXb01cK02CAfgDNQMgn4.m3u8)

---

![hero-sentinel-ai-preview-BXas7Q1_.gif](https://assets.skool.com/f/4e1ca14852434c0abdefff35382cdf66/145f2ed70d7c4a6eb2c6580b69386e7d36a53866418e4ef980916a9cfc9a398d.gif)
...
> 
> <link href="[https://fonts.googleapis.com/css2?family=Sora:wght@300;400;500;600;700&display=swap](https://fonts.googleapis.com/css2?family=Sora:wght@300;400;500;600;700&display=swap)" rel="stylesheet">
> 
...
> 
> Spline 3D Background (absolute, full-size): Lazy-loaded via React.lazy(() => import("@splinetool/react-spline")) wrapped in <Suspense> with a fallback <div className="absolute inset-0 bg-hero-bg" />. The Spline component uses scene="[https://prod.spline.design/Slk6b8kz3LRlKiyk/scene.splinecode](https://prod.spline.design/Slk6b8kz3LRlKiyk/scene.splinecode)" and className="w-full h-full". Placed inside <div className="absolute inset-0">.
> 
...
> IMPORTANT NOTES:
> 
> The Spline scene URL is [https://prod.spline.design/Slk6b8kz3LRlKiyk/scene.splinecode](https://prod.spline.design/Slk6b8kz3LRlKiyk/scene.splinecode) -- this is the exact 3D scene used
> 
