...
> Ruta: Claude Design › Stellar AI

**📎 Recursos:**
- [Stellar AI](https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260319_165750_358b1e72-c921-48b7-aaac-f200994f32fb.mp4)

---

![hero-stellar-ai-preview-D3HL6bw1.gif](https://assets.skool.com/f/4e1ca14852434c0abdefff35382cdf66/5f419803e853498f98d00081528b4072773d045ea2c1482e9cc1818b3f5405ab.gif)

> Create a "[Stellar.ai](http://Stellar.ai)" landing page hero section using React, Tailwind CSS, and Lucide React icons. Use the Inter font (imported from Google Fonts). The page has a white background (bg-white), max-width max-w-7xl, and is centered with mx-auto.
> 
...
> 
> Left: Lucide Star icon (w-5 h-5, fill-black) + "[Stellar.ai](http://Stellar.ai)" text (text-lg font-semibold)
> 
...
> 
> Video: src="[https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260319_165750_358b1e72-c921-48b7-aaac-f200994f32fb.mp4](https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260319_165750_358b1e72-c921-48b7-aaac-f200994f32fb.mp4)", autoPlay, loop, muted, playsInline, w-full h-full object-cover.
> 
