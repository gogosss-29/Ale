...
> Ruta: Claude Design › Urban Jungle

**📎 Recursos:**
- [Urban Jungle](https://motionsites.ai/?prompt=urban-jungle-hero)
- [Jungla Urbana Video](https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260422_112520_ee819691-f2e8-4c54-bb77-3fb72c84eaa5.mp4)

---

![Jungla urbana.gif](https://assets.skool.com/f/4e1ca14852434c0abdefff35382cdf66/77fdbf25790f457cac9d94ae1b23f6e18195693a11214354b07988749437cff2.gif)
...
Custom headline font: Download the font file from [https://dirtylinestudio.com/wp-content/uploads/2022/05/Dirtyline-36daysoftype-2022.woff2](https://dirtylinestudio.com/wp-content/uploads/2022/05/Dirtyline-36daysoftype-2022.woff2) and save it to the public/ directory as Dirtyline-36daysoftype-2022.woff2. Then register it via @font-face in CSS.

Google Fonts (loaded via CSS @import): Manrope:wght@400;500;600;700 and Instrument+Serif:ital@0;1

Tailwind v4 theme (index.css):

@import url('[https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700&family=Instrument+Serif:ital@0;1&display=swap](https://fonts.googleapis.com/css2?family=Manrope:wght@400;500;600;700&family=Instrument+Serif:ital@0;1&display=swap)');
...
[https://stream.mux.com/43NlHXsaMrmyzWamMk87m01fNyxSTekAD669BBAPBNm00.m3u8](https://stream.mux.com/43NlHXsaMrmyzWamMk87m01fNyxSTekAD669BBAPBNm00.m3u8)
...
HOME onClick: [gsap.to](http://gsap.to)(window, { duration: 3, scrollTo: 0, ease: 'power3.inOut' })

ABOUT onClick: [gsap.to](http://gsap.to)(window, { duration: 3, scrollTo: document.body.scrollHeight, ease: 'power3.inOut' })
...
.[pill.is](http://pill.is)-active { background-color: #e0e0e0; }
...
<ScrollVideo src="[https://stream.mux.com/43NlHXsaMrmyzWamMk87m01fNyxSTekAD669BBAPBNm00.m3u8](https://stream.mux.com/43NlHXsaMrmyzWamMk87m01fNyxSTekAD669BBAPBNm00.m3u8)" />
