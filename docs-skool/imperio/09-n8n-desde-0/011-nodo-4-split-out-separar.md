...
![image.png](../imagenes/6e8b67e2718c45cf878c6453af5f641d48c2f7bde16d416e900ec7694f6b930d-md.png)
...
1. Agrega un nodo **Code**. ![image.png](../imagenes/a8758fd183d940de8daed720c6a873c64bb2a297ff0342f1a9f73fc26744dee2-md.png)
...
1. Dale a "Test Step". Verás que sale **1 Item** (color verde). ![image.png](../imagenes/cb1899f14a134702a7a22c0ff3d422a03aa8bc2d0e3b4d57bd098fc64ce9caa9-md.png)

#### **Paso B: Desempaquetar (La Magia)**

Ahora vamos a separar los productos.

1. Agrega el nodo **Split Out** a continuación. ![image.png](../imagenes/99c028024d7646c882dac379889523e55b915854179743b8ad07d5a79896319b-md.png)
2. **Field to Split Out:** Escribe el nombre del campo que contiene la lista. En nuestro ejemplo es: carrito. ![image.png](../imagenes/723a38086c8247718a576e0d9d55e9e9327cde19869a403e9d28f8ba383e219f-md.png)
3. **Include Other Fields:** (Opcional pero útil) Déjalo activado si quieres conservar el id_orden y cliente en cada producto.
4. Dale a **"Test Step"**.
5. Agrega un “send email” en gmail: ![image.png](../imagenes/ef1b7aa2facc4518be9cc7dc6e63b7dd5fb77fb8de644475a5b464a34320e1b4-md.png)
...
![image.png](../imagenes/eac42af5cf204367a23144a091e69ac5080fa41d2b7645a6ad8a514534343967-md.png)

![image.png](../imagenes/1498a30ffaa4406bb1b79e7de8e54928bc81b47d2fc141198402421d105898c4-md.png)

### 

![image.png](../imagenes/53232539cc9a49dbbd745b0579f0f8b74177d601430145bab6b46d5995783403-md.png)

### 

![image.png](../imagenes/71cab768cf4d4aeaafe3f8e56d818b76b829715c33764e0fad4cec91164cc2d0-md.png)
