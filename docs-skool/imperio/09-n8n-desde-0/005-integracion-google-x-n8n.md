...
![image.png](../imagenes/19ac13a96dd64cb8b8de4a729920042c478b302f23244d4ca74690c49b224744-md.png)

1. Busca Gmail OAuth2 API

![image.png](../imagenes/f639f16e271a4379a22841a93ee2867005ff1b7f18894590abcba8d56963503b.png)

1. Fíjate que ahí te pide **Client ID** y **Client Secret**.

![image.png](../imagenes/61a74c8e1d6743fbab80ee882998bd101eede487682e40aebd0e318b7ec347cc-md.png)

1. Copia la **"OAuth Redirect URL"** que aparece ahí mismo. La usaremos en el paso 4.

#### **Paso 2: Crear el Proyecto en Google**

1. Entra a la [Google Cloud Console](https://console.cloud.google.com/). ![image.png](../imagenes/aa4c1fbd9c58484fa160debe7d764b22cad98d2ee6604b9c94f25f5930e08725-md.png)
2. Arriba a la izquierda, selecciona **"Proyecto Nuevo"**.

![image.png](../imagenes/09f5ba58f3a94149ab28dca7077484dd0793b4f0fff1463c89d8d9efdb2bcd64-md.png)

1. Ponle un nombre fácil, por ejemplo: `n8n imperio`.

![image.png](../imagenes/fd16de18b5284256b8ee782bfa49df9b1507a0270cf2454bb60d6d13a6dd4665.png)

1. Dale a crear y asegúrate de **seleccionar el proyecto** que acabas de crear.

![image.png](../imagenes/c31e68b7376a4116b88c8bfc0b1ab142b848219a97ca425b9d270085efbb58c9.png)

Selecciona el proyecto

![image.png](../imagenes/b77813f28a914a509f126b19e40e46540229dded6506463caf26cb80c241367e-md.png)

#### **Paso 3: Habilitar las APIs (La Biblioteca)**

1. En el menú lateral, ve a **"APIs y servicios" > "Bibliotecas"** (o APIs habilitadas).

![image.png](../imagenes/402f4f10b04146548d2fbca04d9416310275adb7a3124803a09a89f4afd7c629.png)

1. 2. Usa el buscador para encontrar la herramienta que quieres conectar. - Si es Drive: Busca `Google Drive API`. ![image.png](../imagenes/625fe18013b34e44ab20bf77ecda6dfd01a3b987114a4b3f9070a96a2763d6a9.png) - Si es Sheets: Busca `Google Sheets API`. ![image.png](../imagenes/ff5a7b91496d41929d2a4f34f78a2705a67b820d72dc411eaf869dbaeba3fedf.png) - Si es Gmail: Busca `Gmail API`.

![image.png](../imagenes/708e314f32f544369a67377003716d705264a3b05bf240fdb0139540d00a43f6-md.png)
...
![image.png](../imagenes/536ddcfbe2334a8bae2db98b24127e02dc1512e35d0c4b6aab1611e5909d6ad6.png)

1. Dale a "Comenzar".

![image.png](../imagenes/cf08aaa70e894db8834397335e506565c55822d5466d4213957fdb3c2b313af3.png)

1. Rellena lo básico: - **Nombre de la App:** `n8n imperio` (o n8n).
- **Correo de asistencia:** Tu email.
- **Información de contacto:** Tu email nuevamente.

![image.png](../imagenes/29d2ea1e91bd4b9b8b9ed99f4adc4e998fe8d9de7edf4c9d921b674de4728da4.png)

Luego dale a externo

![image.png](../imagenes/4e54bb6f7a064db5b3c8cea4804c63c00badcf57963f42e8b1c4779224494886.png)

Dale a "Guardar y Continuar".

![image.png](../imagenes/3345eedbbdf649509a3d75251695cb970b553cac895248bda21afa78d22981cf.png)

#### **Paso 5: Crear las Credenciales (Client ID & Secret)**

1. En el menú lateral, ve a **"Credenciales"** y dale a **"Crear credenciales"**

![image.png](../imagenes/2a2e73ca325a44e09a461a74b26b94ab0351d5480982447bb45c98c79bb49322.png)

Luego ** > "ID de cliente de OAuth"**.

![image.png](../imagenes/bb0d9906d8224a9dabf24ca68774c6bb48876c2fb7914f2cb295dbd6772bb928-md.png)

**Tipo de aplicación:** Aplicación Web.

![image.png](../imagenes/2c9b8325bca1423c91a0571bd58a59b985dd4b60f9cc459f8c0f06b690aa49ad.png)
...
![image.png](../imagenes/69305e1f0a0f4c32929f9cf5e28d7d068293cef119ec4becb59efa6165326b45-md.png)

Y ahora

![image.png](../imagenes/b32ffb71bc5a432f9c0ca1b98be6681e1259d0c41b504902989994b4e261f148.png)
...
![image.png](../imagenes/ea98918e9a47470d8dd60fbb1546b5b5c8b9d9dc7b0f44b89ab8c47566485d06.png)

1. Copia el ID y pégalo en n8n.
2. Copia el Secreto y pégalo en n8n.

![image.png](../imagenes/3dd6998d26884fae9203c947048c1caeeb02b4e67f5d40738e13971d8ef847a5.png)

1. **Ojo! ANTES de conectar:** - Vuelve a Google, ve a **"Acceso a los datos"** (o Scopes) y asegúrate de asociar/habilitar las APIs que activaste. ![image.png](../imagenes/699a2967490d4bb88b72e6cd178d33afdf7cddd1ea5f415780dbaf70a4447dec-md.png) Luego baja al máximo y dale "Mostrar 100" ![image.png](../imagenes/8565fb3b0de5434b8eabf513c4a659feb2b8b68f1a7e4712ac7beacd0422cfbb.png) Dale a seleccionar todas las filas ![image.png](../imagenes/487c4259b39d48869b099574c0b191e34a2a2eca3ea24f5686c196ca5379cd13-md.png) Luego dale a guardar y actualizar ![image.png](../imagenes/6f1cca072dc146a18d4aeb9cdf0551fee624ea0ed54848d9bacaad27b581f939.png) - Ve a **"Usuarios de prueba"** (Test Users) y agrega TU propio correo Gmail. Si no haces esto, no te dejará entrar.

![image.png](../imagenes/ecf80397c5904d41bd24d4bba4e535b7af79ac1ccac042798fa92916f53f945f-md.png)

Dale a guardar

![image.png](../imagenes/8b2a1f451ba74f8e872e1eccfee0cdbf15b7095d8b48445d88f4477f701121cb-md.png)

Luego dale a publicar

![image.png](../imagenes/9fe623ff52d2433c962efdf7760a2636ed288df37c364413b5e677ae89ea714d-md.png)
...
![image.png](../imagenes/8d7d5d3cce12489f99288a4cb793eb244069dac3020c4b48a0f5b1caa08e13cb.png)
...
![image.png](../imagenes/43aa061223f3467780784562be10af8b12d1d9414d64465b9fb1d017aa24c0a0.png)

Elige

![image.png](../imagenes/b5d62b00bda64099906389ced16caf8e43c99004008d4214abc212b6015d154e.png)

Llena tus datos

![image.png](../imagenes/6e360dc3848f48eba90024ea8c539748ab01306f88164adbb427bb669871eefd.png)

Y repite el proceso para sheets...  
  
Ahora puedes enviar correos, extraer data de sheets y guardar cosas en drive.

![image.png](../imagenes/77e99765dd05400b9d6494d59f9cea226863fd6398a7444e99c94972b87ea16d.png)
