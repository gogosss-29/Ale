# 🎥 Como obtener soporte dentro de Imperio Digital

> Ruta: 🛠️ Soporte › 🎥 Como obtener soporte dentro de Imperio Digital

---

Imperiales, en esta comunidad la regla de oro es **no quedarse estancado**.

Tenemos un sistema robusto para asegurar que sigas avanzando. Aquí tienes tus vías para pedir ayuda:

### **1. Los Foros de Skool (24/7)**
...
Los Martes tenemos sesiones exclusivas de Soporte, donde el equipo te soluciona problemas en vivo y en pantalla. 👉 [**Revisa el Calendario AQUÍ**](https://www.skool.com/imperio-digital/calendar)**.**

---

**📚 Grabaciones de Sesiones** También en este módulo encontrarás **TODAS** las grabaciones de las sesiones anteriores. Es el mejor lugar si necesitas ver cómo se hace el paso a paso a tu propio ritmo.

Lo importante es que preguntes y ejecutes. **No descansamos hasta que tus automatizaciones estén 100% funcionando**.
